...
<!-- Mirrored from myrathemes.com/dashtrap/pages-register by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 May 2024 02:04:32 GMT -->
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{route('register-proses')}}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="text" id="name" name="nama" placeholder="Enter your Name" value="{{ old('nama')}}">
                                @error('nama')
                                <small>{{ $message }}</small>
                            @enderror
                            </div>
