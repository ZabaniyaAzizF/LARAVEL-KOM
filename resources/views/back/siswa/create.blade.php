            ...
            @include('back.layout.navbar')
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="py-3 py-lg-4">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h4 class="page-title mb-0">Tambah Data Users</h4>
                                </div>
                                <div class="col-lg-6">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="p-2">
                                                    <form class="form-horizontal" action="{{route('Data-siswa.store')}}" method="post" >
                                                        @csrf
                                                        <div class="mb-2 row">
                                                            <label class="col-md-2 col-form-label" for="simpleinput">NIS</label>
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control" name="nis" placeholder="Isi Nama Anda">
                                                                @error('nama')
                                                                    <small>{{ $message }}</small>
                                                                @enderror
                                                            </div>
