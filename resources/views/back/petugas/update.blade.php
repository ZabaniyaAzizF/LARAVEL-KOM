                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="p-2">
                                                    <form class="form-horizontal" action="{{route('Data-petugas.update', $data->kode_petugas) }}" method="post" >
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="mb-2 row">
                                                            <label class="col-md-2 col-form-label" for="simpleinput">Kode Petugas</label>
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control" name="kode_petugas" value="{{ $data->kode_petugas}}" readonly>
                                                                @error('kode_petugas')
                                                                    <small>{{ $message }}</small>
                                                                @enderror
                                                            </div>
                                                        ...
                                                        <div class="mb-2 row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" name="petugas" class="form-control" value="{{ $data->nama_petugas}}"  placeholder="Isi Nama Kelas">
                                                                @error('petugas')
                                                                <small>{{ $message }}</small>
                                                            @enderror
                                                            </div>
